...
$pwd="GoBlue08!";
$db="pubmed";//STORED PROCEDURE is in database MiMIAnnotation 
//$db="mimiR2";
...
mssql_select_db( $db);
 ...
 //$query="exec getSentfromPubmed_07n_sp '$mol1','$mol2'"; //****if database name 'pubmed_07n' changed, need to change the db name in stored procedure 
   //$query="exec mimiCytoPlugin.mimiR2Pubmed_08n_4mimi '$mol1','$mol2'";
    $query="exec mimiplugin.getSentencesForGeneSymbolPairs '$mol1','$mol2'";
